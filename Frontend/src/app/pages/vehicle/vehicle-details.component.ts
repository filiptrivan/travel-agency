...
import { VehicleBaseDetailsComponent } from 'src/app/business/components/base-details/business-base-details.generated';
...
@Component({
    ...
    imports: [
        ...
        VehicleBaseDetailsComponent
    ]
})
export class VehicleDetailsComponent extends BaseFormCopy implements OnInit {
    vehicleFormGroup = new SpiderlyFormGroup<Vehicle>({});
